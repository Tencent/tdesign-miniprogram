...
checked | Boolean | false | 受控：是否选中 | N
defaultChecked | Boolean | false | 非受控，是否选中 | N
...
value | Array | [] | 受控：选中值。TS 类型：`CheckboxGroupValue`。[详细类型定义](https://github.com/Tencent/tdesign-miniprogram/tree/develop/src/checkbox/type.ts) | N
defaultValue | Array | [] | 非受控：选中值。TS 类型：`CheckboxGroupValue`。[详细类型定义](https://github.com/Tencent/tdesign-miniprogram/tree/develop/src/checkbox/type.ts) | N
