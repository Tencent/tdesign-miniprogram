...
- `Indexes`:
  ...
  - 移除 `scroll-view`，使用全局滚动 @LeeJim ([#1271](https://github.com/Tencent/tdesign-miniprogram/pull/1271))
...
- `Textarea`:
  ...
  - 修复 `less` 变量使用错误 @anlyyao ([#1280](https://github.com/Tencent/tdesign-miniprogram/pull/1280))
...
- `Input`:
  - 外部样式类 `t-class-icon` 变更为` t-class-prefix-icon` @anlyyao ([#1109](https://github.com/Tencent/tdesign-miniprogram/pull/1109))
...
- `Avatar`:
  ...
  - 支持 `imageProps`，并新增 `iconProps` 和 `bordered` 属性 @anlyyao ([#1076](https://github.com/Tencent/tdesign-miniprogram/pull/1076))
### 🐞 Bug Fixes
...
- `Tag`:
  - 视觉更新 [#581](https://github.com/Tencent/tdesign-miniprogram/pull/581) [@anlyyao](https://github.com/anlyyao)
  - 支持 `Icon` 插槽 [#581](https://github.com/Tencent/tdesign-miniprogram/pull/581) [@anlyyao](https://github.com/anlyyao)
- `DropdownMenu`:
  - 新增 `toggle` 示例方法，用于切换下拉菜单 [#584](https://github.com/Tencent/tdesign-miniprogram/pull/584) [@LeeJim](https://github.com/LeeJim)
  - 新增 `keys` 属性以支持自定义 `label` 和 `value` 的字段名 [#582](https://github.com/Tencent/tdesign-miniprogram/pull/582) [@LeeJim](https://github.com/LeeJim)
- `Popup`:
  - 新增 `duration` 属性，控制动画过渡时间 [#585](https://github.com/Tencent/tdesign-miniprogram/pull/585) [@LeeJim](https://github.com/LeeJim)
  - 新增 `customStyle` 透传样式至根节点 [#585](https://github.com/Tencent/tdesign-miniprogram/pull/585) [@LeeJim](https://github.com/LeeJim)
  - 新增 `overlayProps` 属性，透传至 `overlay` 组件 [#585](https://github.com/Tencent/tdesign-miniprogram/pull/585) [@LeeJim](https://github.com/LeeJim)
...
- `Dialog`:
  ...
  - 修复点击遮罩层不会触发 `close` 事件的问题 [#566](https://github.com/Tencent/tdesign-miniprogram/pull/566) [@LeeJim](https://github.com/LeeJim)
- `DropdownMenu`: 修复默认层级问题 [#553](https://github.com/Tencent/tdesign-miniprogram/pull/553) [@webwyb](https://github.com/webwyb)
- `Drawer`: 修复默认层级问题 [#553](https://github.com/Tencent/tdesign-miniprogram/pull/553) [@webwyb](https://github.com/webwyb)
- `Message`: 修复默认层级问题 [#553](https://github.com/Tencent/tdesign-miniprogram/pull/553) [@webwyb](https://github.com/webwyb)
- `Popup`: 修复默认层级问题 [#553](https://github.com/Tencent/tdesign-miniprogram/pull/553) [@webwyb](https://github.com/webwyb)
...
- `Picker`:
  - 新增 `confirm` 事件，返回参数和 `change` 一致 [#565](https://github.com/Tencent/tdesign-miniprogram/pull/565) [@LeeJim](https://github.com/LeeJim)
  - `confirm`、`change`、`pick` 事件均返回 `label` 参数 [#565](https://github.com/Tencent/tdesign-miniprogram/pull/565) [@LeeJim](https://github.com/LeeJim)
...
### 🐞 Bug Fixes
- `Textarea`:
  - 修复字数统计不生效的问题 [#510](https://github.com/Tencent/tdesign-miniprogram/pull/510) [@anlyyao](https://github.com/anlyyao)
  - 移除无用的组件依赖  [#520](https://github.com/Tencent/tdesign-miniprogram/pull/520) [@LeeJim](https://github.com/LeeJim)
### 🚀 Featuress
...
### 🚨 Breaking Changes
- `Picker`:
  - 事件 `change` 更名为 `pick`  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
  - 事件 `confirm` 更名为 `change`  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
- `PickerItem`: 移除 `value` 属性  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
- DateTimePicker:
  - 新增 `start` 和 `end` 属性用于替代 `disable-date` 属性  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
  - 移除 `disable-date` 属性  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
  - 事件 `change` 更名为 `pick`  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
  - 事件 `confirm` 更名为 `change`  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
  - 移除 `column-change` 事件  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
  - 属性 `format` 默认值改成 `''`  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
  - 重构了事件返回参数，在传入了 `format` 属性时，`value` 则是格式化之后的值，否则就是 `picker-item` 的值  [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@wutianSweet](https://github.com/wutianSweet)
### 🐞 Bug Fixes
...
### 🚨 Breaking Changes
- `Collapse`:
  - `expandIcon` 默认值从 `true` 改成 `null` [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@LeeJim](https://github.com/LeeJim)
  - `headerRightContent` 移除 `boolean` 类型 [#462](https://github.com/Tencent/tdesign-miniprogram/pull/462) [@LeeJim](https://github.com/LeeJim)
### 🐞 Bug Fixes
...
- `DropdownMenu`:
  - 修正遮罩层的位置，以及下拉菜单的高度 [#456](https://github.com/Tencent/tdesign-miniprogram/pull/456) [@LeeJim](https://github.com/LeeJim)
  - 修复菜单选项点击区域过小的问题 [#457](https://github.com/Tencent/tdesign-miniprogram/pull/457) [@LeeJim](https://github.com/LeeJim)
...
### 🚀 Featuress
- `Input`:
  - 完善 `change` 事件，增加返回 `cursor` 和 `keyCode` 数据 [#434](https://github.com/Tencent/tdesign-miniprogram/pull/434) [@LeeJim](https://github.com/LeeJim)
  - 增加 `keyboardheightchange` 事件，键盘高度发生变化的时候触发 [#434](https://github.com/Tencent/tdesign-miniprogram/pull/434) [@LeeJim](https://github.com/LeeJim)
  - 增加占位符相关属性：`placehoderStyle` 和 `placeholderClass` [#434](https://github.com/Tencent/tdesign-miniprogram/pull/434) [@LeeJim](https://github.com/LeeJim)
  - 增加光标相关属性：`cursor`、`selection-start`、`selection-end` [#434](https://github.com/Tencent/tdesign-miniprogram/pull/434) [@LeeJim](https://github.com/LeeJim)
  - 增加 `hold-keyboard` 属性 [#434](https://github.com/Tencent/tdesign-miniprogram/pull/434) [@LeeJim](https://github.com/LeeJim)
  - 增加安全键盘相关属性 [#434](https://github.com/Tencent/tdesign-miniprogram/pull/434) [@LeeJim](https://github.com/LeeJim)
  - 支持 `borderless` 属性 [3cd7d58](https://github.com/Tencent/tdesign-miniprogram/commit/3cd7d58beed539914382784701e1b611293ad257) [@LeeJim](https://github.com/LeeJim)
...
### 🐞 Bug Fixes
- `Picker`:
  - 修复滑动延迟的问题 [#415](https://github.com/Tencent/tdesign-miniprogram/pull/415) [@LeeJim](https://github.com/LeeJim)
...
- `ActionSheet`: 修复样式告警问题 [#431](https://github.com/Tencent/tdesign-miniprogram/pull/431) [@anlyyao](https://github.com/anlyyao)
- `ImageViewer`: 修复样式告警问题 [#431](https://github.com/Tencent/tdesign-miniprogram/pull/431) [@anlyyao](https://github.com/anlyyao)
- `Steps`: 修复样式告警问题 [#431](https://github.com/Tencent/tdesign-miniprogram/pull/431) [@anlyyao](https://github.com/anlyyao)
...
### 🚀 Featuress
- `Collapse`: 新增折叠面板组件 [#322](https://github.com/Tencent/tdesign-miniprogram/pull/322) [@LeeJim](https://github.com/LeeJim)
- `Progress`: 新增进度条组件 [#318](https://github.com/Tencent/tdesign-miniprogram/pull/318) [@anlyyao](https://github.com/anlyyao)
...
### 🚀 Featuress
- `Fab`: 新增悬浮按钮组件 [#310](https://github.com/Tencent/tdesign-miniprogram/pull/310) [@LeeJim](https://github.com/LeeJim)
- `Drawer`: 新增抽屉组件 [#308](https://github.com/Tencent/tdesign-miniprogram/pull/308) [@anlyyao](https://github.com/anlyyao)
...
### 🚀 Features
- `Grid`: 增加点击态：[#279](https://github.com/Tencent/tdesign-miniprogram/pull/279) [@Perisiguiendo](https://github.com/Perisiguiendo)
- `TabBar`: 增加点击态：[#279](https://github.com/Tencent/tdesign-miniprogram/pull/279) [@Perisiguiendo](https://github.com/Perisiguiendo)
...
- `Input`: 修复在 `form` 下无法获取值的问题 [#256](https://github.com/Tencent/tdesign-miniprogram/pull/256) [@anlyyao](https://github.com/anlyyao)
- `Checkbox`: 修复在 `form` 下无法获取值的问题 [#257](https://github.com/Tencent/tdesign-miniprogram/pull/257) [@anlyyao](https://github.com/anlyyao)
- `Radio`: 修复在 `form` 下无法获取值的问题 [#257](https://github.com/Tencent/tdesign-miniprogram/pull/257) [@anlyyao](https://github.com/anlyyao)
- `Switch`: 修复在 `form` 下无法获取值的问题 [#257](https://github.com/Tencent/tdesign-miniprogram/pull/257) [@anlyyao](https://github.com/anlyyao)
...
### 🚨 Breaking Changes
- `Button`:
  - 重构 `shape` 的实现，新增支持 `rectangle`、`circle` 类型 [#212](https://github.com/Tencent/tdesign-miniprogram/pull/212) [@anlyyao](https://github.com/anlyyao)
  - 修复 `shape = round` 样式不对的问题 [#212](https://github.com/Tencent/tdesign-miniprogram/pull/212) [@anlyyao](https://github.com/anlyyao)
  - 支持纯图标按钮 [#212](https://github.com/Tencent/tdesign-miniprogram/pull/212) [@anlyyao](https://github.com/anlyyao)
### 🐞 Bug Fixes
...
## 🌈 0.5.4 `2022-3-4`
### 🐞 Bug Fixes
- `Slider`: 视觉调整 & `demo` 无法滑动问题修复 [#200](https://github.com/Tencent/tdesign-miniprogram/pull/200) [@anlyyao](https://github.com/anlyyao)
- `Search`: 修复圆角样式不生效问题 [#208](https://github.com/Tencent/tdesign-miniprogram/pull/208) [@JJunYang](https://github.com/JJunYang)
- `TabBar`: 修复 `value` 不生效问题 [#211](https://github.com/Tencent/tdesign-miniprogram/pull/211) [@LeeJim](https://github.com/LeeJim)
### 🚀 Features
...
- `Search`:
  - 移除受控用法 [#195](https://github.com/Tencent/tdesign-miniprogram/pull/195) [@LeeJim](https://github.com/LeeJim)
  - 支持双向绑定 [#195](https://github.com/Tencent/tdesign-miniprogram/pull/195) [@LeeJim](https://github.com/LeeJim)
  - 修复 `placeholder` 展示错误的问题 [#195](https://github.com/Tencent/tdesign-miniprogram/pull/195) [@LeeJim](https://github.com/LeeJim)
...
## 🌈 0.5.0 `2022-1-28`
### 🚨 Breaking Changes
- `Checkbox`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#158](https://github.com/Tencent/tdesign-miniprogram/pull/158) [@amberlwan](https://github.com/amberlwan)
- `Upload`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#156](https://github.com/Tencent/tdesign-miniprogram/pull/156) [@LeeJim](https://github.com/LeeJim)
- `Search`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#152](https://github.com/Tencent/tdesign-miniprogram/pull/152) [@LeeJim](https://github.com/LeeJim)
- `Slider`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#151](https://github.com/Tencent/tdesign-miniprogram/pull/151) [@LeeJim](https://github.com/LeeJim)
- `Stepper`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#150](https://github.com/Tencent/tdesign-miniprogram/pull/150) [@LeeJim](https://github.com/LeeJim)
- `Rate`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#149](https://github.com/Tencent/tdesign-miniprogram/pull/149) [@LeeJim](https://github.com/LeeJim)
- `TabBar`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#148](https://github.com/Tencent/tdesign-miniprogram/pull/148) [@LeeJim](https://github.com/LeeJim)
- `Tabs`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#147](https://github.com/Tencent/tdesign-miniprogram/pull/147) [@LeeJim](https://github.com/LeeJim)
- `Steps: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀` [#146](https://github.com/Tencent/tdesign-miniprogram/pull/146) [@LeeJim](https://github.com/LeeJim)
- `Radio`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#143](https://github.com/Tencent/tdesign-miniprogram/pull/143) [@LeeJim](https://github.com/LeeJim)
- `Tag`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#130](https://github.com/Tencent/tdesign-miniprogram/pull/130) [@LeeJim](https://github.com/LeeJim)
- `Dialog`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#124](https://github.com/Tencent/tdesign-miniprogram/pull/124) [@LeeJim](https://github.com/LeeJim)
- `Switch`: 组件支持受控用法，对应的非受控属性增加了 `default` 前缀 [#122](https://github.com/Tencent/tdesign-miniprogram/pull/122) [@LeeJim](https://github.com/LeeJim)
...
- `Search`:
  - 属性 `actionText` 变更为 `action`  [#152](https://github.com/Tencent/tdesign-miniprogram/pull/152) [@LeeJim](https://github.com/LeeJim)
  - 属性 `keyword` 变更为 `value`  [#152](https://github.com/Tencent/tdesign-miniprogram/pull/152) [@LeeJim](https://github.com/LeeJim)
### 🐞 Bug Fixes
- `Loading`: 修复基础样式丢失的问题 [#140](https://github.com/Tencent/tdesign-miniprogram/pull/140) [@JJunYang](https://github.com/JJunYang)
- `Badge`: 修复基础样式丢失的问题 [#131](https://github.com/Tencent/tdesign-miniprogram/pull/131) [@Perisiguiendo](https://github.com/Perisiguiendo)
- `Avatar`: 修复基础样式丢失的问题 [#116](https://github.com/Tencent/tdesign-miniprogram/pull/116) [@Perisiguiendo](https://github.com/Perisiguiendo)
...
## 🌈 0.4.0 `2021-12-30`
### 🚨 Breaking Changes
- `Slider`: `CSS` 类名规范 [#45](https://github.com/Tencent/tdesign-miniprogram/pull/45) [@JJunYang](https://github.com/JJunYang)
- `Stepper`: `CSS` 类名规范 [#46](https://github.com/Tencent/tdesign-miniprogram/pull/46) [@JJunYang](https://github.com/JJunYang)
- `Button`: `CSS` 类名规范 [#51](https://github.com/Tencent/tdesign-miniprogram/pull/51) [@LeeJim](https://github.com/LeeJim)
- `Search`: `CSS` 类名规范 [#54](https://github.com/Tencent/tdesign-miniprogram/pull/54) [@JJunYang](https://github.com/JJunYang)
- `Upload`: `CSS` 类名规范 [#55](https://github.com/Tencent/tdesign-miniprogram/pull/55) [@JJunYang](https://github.com/JJunYang)
- `Radio`: `CSS` 类名规范 [#56](https://github.com/Tencent/tdesign-miniprogram/pull/56) [@LeeJim](https://github.com/LeeJim)
### 🐞 Bug Fixes
...
## 🌈 0.3.0 `2021-12-23`
### 🚨 Breaking Changes
- `Textarea`: `CSS` 类名规范 [#26](https://github.com/Tencent/tdesign-miniprogram/pull/26) [@JJunYang](https://github.com/JJunYang)
- `Toast`: `CSS` 类名规范 [#27](https://github.com/Tencent/tdesign-miniprogram/pull/27) [@jin0209](https://github.com/jin0209)
- `Sticky`: `CSS` 类名规范 [#24](https://github.com/Tencent/tdesign-miniprogram/pull/24) [@jin0209](https://github.com/jin0209)
- `Search`: `CSS` 类名规范 [#28](https://github.com/Tencent/tdesign-miniprogram/pull/28) [@JJunYang](https://github.com/JJunYang)
- `TabBar`: `CSS` 类名规范 [#34](https://github.com/Tencent/tdesign-miniprogram/pull/34) [@LeeJim](https://github.com/LeeJim)
- `BackTop`: `CSS` 类名规范 [#35](https://github.com/Tencent/tdesign-miniprogram/pull/35) [@LeeJim](https://github.com/LeeJim)
- `Skeleton`: `CSS` 类名规范 [#20](https://github.com/Tencent/tdesign-miniprogram/pull/20) [@jin0209](https://github.com/jin0209)
- `PullDownRefresh`: `CSS` 类名规范 [#38](https://github.com/Tencent/tdesign-miniprogram/pull/38) [@jin0209](https://github.com/jin0209)
### 🐞 Bug Fixes
...
## 🌈 0.2.0 `2021-12-20`
### 🚨 Breaking Changes
- `Cell`: `CSS` 类名规范 [[4a0db04]](https://github.com/Tencent/tdesign-miniprogram/commit/4a0db04768f56016b27405090890d8fcb113c38b) [@jin0209](https://github.com/jin0209)
- `Grid`: `CSS` 类名规范 [[13c77c9]](https://github.com/Tencent/tdesign-miniprogram/commit/13c77c93f55e04d7fac144ba5a0b16d336642080) [@jin0209](https://github.com/jin0209)
- `Tabs`:
  - `CSS` 类名规范 [[e064d8e]](https://github.com/Tencent/tdesign-miniprogram/commit/e064d8e7fd6c33e81b399bf0b5c15f21ebc7c38e) [@jin0209](https://github.com/jin0209)
  - 移除 `click` 事件 [[5973c8a]](https://github.com/Tencent/tdesign-miniprogram/commit/5973c8a76e18fe68bfba81a26ff78a30f11cd5eb) [@JJunYang](https://github.com/JJunYang)
- `NavBar`: `CSS` 类名规范 [[249af24]](https://github.com/Tencent/tdesign-miniprogram/commit/249af24a8dc05eb868d63138069ad13858a586eb) [@jin0209](https://github.com/jin0209)
- `CountDown`: `CSS` 类名规范 [[c6ce131]](https://github.com/Tencent/tdesign-miniprogram/commit/c6ce131cdfd453c8250124d874d6a705a4332a07) [@jin0209](https://github.com/jin0209)
- `Image`: `CSS` 类名规范 [[707f9ec]](https://github.com/Tencent/tdesign-miniprogram/commit/707f9ec91cf95a70db86c6dc519d0c4ad869a9c0) [@jin0209](https://github.com/jin0209)
- `Footer`: `CSS` 类名规范 [[15036a7]](https://github.com/Tencent/tdesign-miniprogram/commit/15036a75f47244fb859f067309a8a8288b4b606d) [@jin0209](https://github.com/jin0209)
- `Divider`: `CSS` 类名规范 [[4cad692]](https://github.com/Tencent/tdesign-miniprogram/commit/4cad69212ab4d71fc84014a82a43440ac9c47592) [@jin0209](https://github.com/jin0209)
- `Avatar`: `CSS` 类名规范 [[b7ef036]](https://github.com/Tencent/tdesign-miniprogram/commit/b7ef036106a662275941c4217c4e870a2460736f) [@jin0209](https://github.com/jin0209)
- `Badge`: `CSS` 类名规范 [[154a087]](https://github.com/Tencent/tdesign-miniprogram/commit/154a0870f8565f42168990af207051b0c2e427d4) [@jin0209](https://github.com/jin0209)
- `Indexes`: `CSS` 类名规范 [[bf0ae0]](https://github.com/Tencent/tdesign-miniprogram/commit/bf0ae05dc0f419aa0a50904f0d22221f67526b18) [@jin0209](https://github.com/jin0209)
- `Input`: `CSS` 类名规范 [[6201113]](https://github.com/Tencent/tdesign-miniprogram/commit/6201113a3a7d114b75ca7813ac4c6cb74ccbbf1f) [@JJunYang](https://github.com/JJunYang)
- `Checkbox`: `CSS` 类名规范 [[6bf8fc8]](https://github.com/Tencent/tdesign-miniprogram/commit/6bf8fc8c49abf9084c4f968374896ae63270c0a7) [@JJunYang](https://github.com/JJunYang)
### 🐞 Bug Fixes
