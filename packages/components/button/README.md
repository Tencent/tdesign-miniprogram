...
session-from | String | - | 会话来源，open-type="contact"时有效，长度不超过 1024 个字符 | N
...
--td-button-extra-small-padding-horizontal | @spacer | -
...
--td-button-medium-padding-horizontal | @spacer-2 | -
...
--td-button-small-padding-horizontal | @spacer-1 | -
