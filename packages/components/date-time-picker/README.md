...
<a href="https://developers.weixin.qq.com/s/hts3GMmc8c5q" title="在开发者工具中预览效果" target="_blank" rel="noopener noreferrer"> 在开发者工具中预览效果 </a>
...
custom-locale | String | zh | 已废弃。 组件国际化语言，目前支持: 简体中文(zh)、(tc)、英文(en)、日语(ja)、韩语(ko)、俄语(ru)等六种语言 | N
