<template>
  <view>
    ...
    <view class="demo-wrapper">
      <t-badge dot t-class="wrapper" content="消息" />
      <t-badge dot :offset="[1, -1]" t-class="wrapper">
    ...
    <view class="demo-wrapper">
      <t-badge count="8" content="消息" :offset="[4]" t-class="wrapper" />
      <t-badge count="2" :offset="[2, -2]" t-class="wrapper">
        <t-icon name="notification" size="48rpx" aria-label="通知" />
      </t-badge>
      <t-badge count="8" :offset="[2, 2]" t-class="wrapper">
        <t-button>按钮</t-button>
      </t-badge>
    </view>
