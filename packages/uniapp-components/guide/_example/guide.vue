<template>
  <view>
    <view class="custom-navbar">
      <t-demo-navbar custom-class="demo-navbar" title="Guide" />
    </view>
    ...
    <view class="demo">
      ...
      <t-demo title="01 组件类型" desc="基础引导" padding>
        <view style="text-align: center">
          <t-button theme="primary" content="用户引导" @click="handleBaseClick" />
        </view>
        <t-popup :visible="visibleBasePopup" placement="bottom" :show-overlay="false">
          <view :style="'height: calc(100vh - ' + navbarHeight + 'px)'">
            <base-demo v-if="visibleBase" @close="handleBaseClose" />
          </view>
        </t-popup>
      </t-demo>
      <t-demo desc="不带遮罩的引导" padding>
        <view style="text-align: center">
          <t-button theme="primary" content="用户引导" @click="handleNoMaskClick" />
        </view>
      ...
      <t-demo desc="弹窗形式的引导" padding>
        <view style="text-align: center">
          <t-button theme="primary" content="用户引导" @click="handleDialogClick" />
        </view>
        <t-popup :visible="visibleDialogPopup" placement="bottom" :show-overlay="false">
          <view :style="'height: calc(100vh - ' + navbarHeight + 'px)'">
            <dialog-demo v-if="visibleDialog" @close="handleDialogClose" />
          </view>
        </t-popup>
      </t-demo>
      <t-demo desc="气泡与弹窗混合的引导" padding>
        <view style="text-align: center">
          <t-button theme="primary" content="用户引导" @click="handleDialog1Click" />
        </view>
        <t-popup :visible="visibleDialog1Popup" placement="bottom" :show-overlay="false">
          <view :style="'height: calc(100vh - ' + navbarHeight + 'px)'">
            <multiple-demo v-if="visibleDialog1" @close="handleDialog1Close" />
          </view>
        </t-popup>
      </t-demo>
      <t-demo desc="自定义气泡" padding>
        <view style="text-align: center">
          <t-button theme="primary" content="用户引导" @click="handleContentClick" />
        </view>
        <t-popup :visible="visibleContentPopup" placement="bottom" :show-overlay="false">
          <view :style="'height: calc(100vh - ' + navbarHeight + 'px)'">
            <content-demo v-if="visibleContent" @close="handleContentClose" />
          </view>
        </t-popup>
      </t-demo>
    </view>
