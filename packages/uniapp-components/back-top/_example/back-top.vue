<template>
  <view>
    <t-demo-navbar custom-class="demo-navbar" title="BackTop" />
    <view class="demo">
      <t-demo-header
        title="BackTop 返回顶部"
      ...
      <t-demo padding>
        <view class="container-flex">
          <t-skeleton :row-col="rowCol" t-class="skeleton-item" loading />
          <t-skeleton :row-col="rowCol" t-class="skeleton-item" loading />
          <t-skeleton :row-col="rowCol" t-class="skeleton-item" loading />
          <t-skeleton :row-col="rowCol" t-class="skeleton-item" loading />
          <t-skeleton :row-col="rowCol" t-class="skeleton-item" loading />
      ...
      <base-demo v-if="type == 'round'" :scroll-top="scrollTop" />
