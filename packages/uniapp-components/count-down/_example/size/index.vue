<template>
  <view>
    ...
    <view class="demo-count-down">
      ...
      <view class="demo-count-down-content">
        <t-count-down size="small" format="HH:mm:ss" :time="time" split-with-unit theme="round" />
      </view>
      <view class="demo-count-down-content">
        <t-count-down format="HH:mm:ss" :time="time" split-with-unit theme="round" />
      </view>
      <view class="demo-count-down-content">
        <t-count-down size="large" format="HH:mm:ss" :time="time" split-with-unit theme="round" />
      </view>
    </view>
  </view>
</template>
